  ...
  if (!companyId) {
    return (
      <Card>
        ...
        <Link href="/superuser" className="text-brand underline">
          Zur Firmenübersicht
        </Link>
      </Card>
    );
...
export default function SuperuserBrandingPage() {
  return (
    <div className="min-h-screen pb-16">
      <AppHeader title="Superuser – Branding" />
      <div className="mx-auto max-w-3xl px-4 py-8">
        <Link href="/superuser" className="mb-4 inline-block text-sm text-brand underline">
          ← Firmen
        </Link>

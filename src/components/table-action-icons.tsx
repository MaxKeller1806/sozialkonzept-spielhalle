/** Line-Icons für Tabellen-Aktionen und Toolbars (keine externe Abhängigkeit). */
...
export function IconPalette({ className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.9 0 1.5-.7 1.5-1.5 0-.4-.2-.8-.4-1.1-.2-.3-.5-.7-.5-1.1 0-.8.7-1.5 1.5-1.5H16c3.3 0 6-2.7 6-6 0-5.5-4.5-10-10-10z" />
    </svg>
  );
}

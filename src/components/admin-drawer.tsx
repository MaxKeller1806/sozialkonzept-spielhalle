  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div
        ...
        className="relative flex h-full w-full max-w-2xl flex-col bg-white shadow-2xl max-sm:max-w-none"
      >
        <header className="flex shrink-0 items-start justify-between gap-3 border-b border-slate-200 px-5 py-4">
          <h2 id="admin-drawer-title" className="text-lg font-bold text-slate-900">
            {title}
          </h2>
          <button
            type="button"
